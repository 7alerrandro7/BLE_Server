...
public class CustomProfile {
    ...
    /* Mandatory Custom Read Information Characteristic */
    ...
    public static BluetoothGattService createSecurityService() {
        ...
        // Receive auth information from HUB characteristic
